...
class _HomeScreenState extends State<HomeScreen> {
              ...
              children: [
                ...
                Autocomplete<String>(
                  optionsBuilder: (textEditingValue) {
                    ...
                    return existingGroups.where((g) => g
                        .toLowerCase()
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(
          ...
          onSubmitted: (_) async {
            ...
            if (name.isEmpty) return;
            await context.read<SeatingPlanListProvider>().renamePlan(plan, name);
  ...
  void _showChangeGroupDialog(SeatingPlan plan) {
    ...
    final controller = TextEditingController(text: plan.groupName ?? '');
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            onPressed: () {
              context.read<SeatingPlanListProvider>().deletePlan(plan.id!);
              Navigator.pop(ctx);
            },
          ...
          return ListView(
            ...
            children: [
              for (final groupName in sortedKeys) ...[
                ...
                for (final plan in grouped[groupName]!)
                  _buildPlanCard(plan),
              ],
            ],
          );
